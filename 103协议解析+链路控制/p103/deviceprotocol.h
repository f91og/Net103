...
public:
    ...
    void QueryWaveFileList();
    void GetLuBo(const QByteArray& file_name);
    void QueryChanel();
    uchar GetRIIAndInc();

signals:
    void reciveAllLuBoPacket(const QByteArray& file_name);
...
private:
    ...
    void HandleQueryChannel(const QByteArray& data);
    void HandleYXWithSOE(const QByteArray& data);
...
private:
    ...
    QDateTime m_QueryWaveFileListTime;
    ...
    QList<CAsdu21> m_lstQueryChannelPack;
